...
include "storescripts/connect_to_mysql.php"; //includes the script

$dynamicList =""; //instantiate the dynamicList Variable
$sql = mysqli_query($con, "SELECT * FROM products ORDER BY date_added DESC LIMIT 6"); //query mysqli
...
<td>
 <div>
 <?php include_once("template_category.php");?>
 <div id="pageContent">
</td>
</tr>
  <p>&nbsp;</p>
